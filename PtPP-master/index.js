...
express()
  ...
  .set('view engine', 'ejs')
  .get('/', (req, res) => res.render('pages/sponsorForm'))
...
function sponsorSubmit(){
  ...
  console.log('1') */
  let sponCompName = document.getElementById('sponCompName').value;
  /* let sponCompName = 'Example';
  console.log('2'); */
  let sponPhoneNum = document.getElementById('sponPhoneNum').value;
  /* let sponPhoneNum = 'Example'; */
  console.log('4');
  let sponEmail = document.getElementById('sponEmail').value; 
  //let sponEmail = 'Example@Example.Example';
  console.log('5');
  /* let sponPackage ="Silver"; */
  let sponAmtVal = document.getElementById('sponAmtVal').value;
